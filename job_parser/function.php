...
<body>
	<div class="mid">
		<form action="function.php" name="parser" method="post">
...
if($file_headers[0] == 'HTTP/1.1 404 Not Found') {
	...
	$robotsTxt = file_get_contents($urlToParser);
			...
			print_r(get_headers($urlToParser));
			echo "<br /><br />";
			print_r(get_headers($urlToParser, 1)); 

	echo "<br /><br />";


	echo "КІЛЬКІСТЬ HOST<br />";
	echo substr_count(strtolower($robotsTxt), 'host:');
	$host_count = substr_count(strtolower($robotsTxt), 'host:');

	echo "<br /><br />";
	echo "Розмір robots.txt<br />";
	...
	echo "sitemap<br />";
	echo substr_count(strtolower($robotsTxt), 'sitemap:');
